...
const AdminAnalytics: React.FC = () => {
  ...
  const chartData = [
    ...
    { name: 'Payment Issues', value: 32 },
    { name: 'Account Issues', value: 28 },
    { name: 'Other', value: 51 }
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">84.6% resolution rate</p>
          </CardContent>
        </Card>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Issue #123 resolved by Admin User</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">New issue created by John Doe</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Issue #121 assigned to Support Team</p>
