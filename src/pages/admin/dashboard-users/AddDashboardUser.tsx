    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          name: values.name,
          email: values.email,
          user_id: values.userId, // Added user_id field
          employee_id: values.employeeId || null,
          phone: values.phone || null, // Added phone field
          city: values.city || null, // Added city field
          cluster: values.cluster || null, // Added cluster field
          manager: values.manager || null, // Added manager field
          role: values.role,
