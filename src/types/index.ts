...
// Import the DashboardRole from services/dashboard/types
import { DashboardRole } from '@/services/dashboard/types';
...
// Row data interface - simplified to remove unneeded fields
