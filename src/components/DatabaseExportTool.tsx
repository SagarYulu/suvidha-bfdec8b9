...
import { Download, Database, FileText, Table, CheckCircle, AlertCircle } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <ol className="text-sm text-blue-800 space-y-1">
                  <li>1. Download your preferred export format above</li>
                  <li>2. Set up your standalone database (PostgreSQL, MySQL, etc.)</li>
                  <li>3. Import the data using the SQL file or CSV files</li>
