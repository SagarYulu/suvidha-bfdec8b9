...
export const ISSUE_TYPES: IssueType[] = [
  ...
  },
  {
    ...
    subTypes: [
      ...
      { id: "nominee-details", label: "Nominee details approval" },
      { id: "uan-activation", label: "UAN Activation" },
      { id: "need-uan-number", label: "Need UAN Number" },
    ]
  },
  {
    id: "esi",
    ...
    subTypes: [
      ...
      { id: "change-personal-details", label: "Need to change Name/Phone Number/Date of Birth/Address" },
    ]
  },
  {
    id: "leave",
